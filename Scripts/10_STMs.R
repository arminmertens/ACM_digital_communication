...
clean.text <- function(some_txt)
{
  ...
  some_txt = gsub(pattern = '[ä]', replacement = "ae",some_txt)
  some_txt = gsub(pattern = '[ü]', replacement = "ue",some_txt)
  some_txt = gsub(pattern = '[ö]', replacement = "oe",some_txt)
...
clean.text2 <- function(some_txt) {
  ...
  some_txt = gsub(pattern = '[ü]', replacement = "ue",some_txt)
  some_txt = gsub(pattern = '[ö]', replacement = "oe",some_txt)
  some_txt = gsub(pattern = '[è]', replacement = "e",some_txt) 
  some_txt = gsub(pattern = '[Ö]', replacement = "Oe",some_txt) 
  some_txt = gsub(pattern = '[é]', replacement = "e",some_txt)
